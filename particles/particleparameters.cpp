...
bool ParticleParameters::addParameters() {
   ...
   Readparameters::add("particles.end_time", "Simulation time (seconds) at which particle simulation stops.", P::end_time);
   ...
   Readparameters::add("particles.rho_field_name", "Name of the Density data set in the input files", P::rho_field_name);
   Readparameters::add("particles.divide_rhov_by_rho", "Do the input file store rho_v and rho separately?", P::divide_rhov_by_rho);
   ...
   Readparameters::add("particles.particle_vel", "Initial velocity of the particles (in the plasma rest frame)", P::particle_vel);
   ...
   Readparameters::add("particles.reflect_start_y",
         "Y-Coordinate of the bottom end of the parabola, at which shock reflection scenario particles are injected",P::reflect_start_y);
   Readparameters::add("particles.reflect_stop_y",
         "Y-Coordinate of the bottom end of the parabola, at which shock reflection scenario particles are injected", P::reflect_stop_y);
   ...
   Readparameters::add("particles.reflect_x_offset",
         "X-Coordinate of the tip of the injection parabola for the reflection scenario", P::reflect_x_offset);
   Readparameters::add("particles.reflect_upstream_boundary",
         "Distance from particle injection point at which particles are to be counted as 'reflected'", P::reflect_upstream_boundary);
   Readparameters::add("particles.reflect_downstream_boundary",
         "Distance from particle injection point at which particles are to be counted as 'transmitted'", P::reflect_downstream_boundary);

   // Parameters for ip shock injection test mode
   Readparameters::add("particles.ipshock_inject_x0",
         "X-Coordinate of the lower edge of particle injection region for the ipShock scenario", P::ipshock_inject_x0);
   Readparameters::add("particles.ipshock_inject_x1",
         "X-Coordinate of the upper edge of particle injection region for the ipShock scenario", P::ipshock_inject_x1);
   Readparameters::add("particles.ipshock_inject_y0",
         "Y-Coordinate of the lower edge of particle injection region for the ipShock scenario", P::ipshock_inject_y0);
   Readparameters::add("particles.ipshock_inject_y1",
         "Y-Coordinate of the upper edge of particle injection region for the ipShock scenario", P::ipshock_inject_y1);
   Readparameters::add("particles.ipshock_inject_z0",
         "Z-Coordinate of the lower edge of particle injection region for the ipShock scenario", P::ipshock_inject_z0);
   Readparameters::add("particles.ipshock_inject_z1",
         "Z-Coordinate of the upper edge of particle injection region for the ipShock scenario", P::ipshock_inject_z1);
   Readparameters::add("particles.ipshock_transmit",
         "X-Coordinate of threshold for where particles are counted  as transmitted for the ipShock scenario", P::ipshock_transmit);
   Readparameters::add("particles.ipshock_reflect",
         "X-Coordinate of threshold for where particles are counted  as reflected for the ipShock scenario", P::ipshock_reflect);
