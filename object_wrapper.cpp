...
bool ObjectWrapper::addParameters() {
   ...
   std::function<void(const std::string)> lambda_fun = [this](std::string s) {
      ...
      //   int uh;
      //   RP::get_app()->add_option("HACKY",uh)->each(lamba_funny)->force_callback(true)->callback_priority(CLI::CallbackPriority::First);
      //   // RP::add_each_lambda("HACKY","",RP::CLI11FunctionHack,lamba_funny);
      // }
   };
   std::cout << "WHAT THE FUCK IS GOING ONNNN" << std::endl;
...
bool ObjectWrapper::getPopulationParameters() {
   ...
   for (unsigned int i = 0; i < getObjectWrapper().particleSpecies.size(); i++) {
      ...
      std::cout << "MASS=" << species.mass << std::endl;
      ...
      std::cout << "BLOCK LENGTH=" << vMesh.blockLength[0] << std::endl;
      std::cout << "BLOCK SIZE=" << vMesh.blockSize[0] << std::endl;
      std::cout << "CELLSIZE=" << vMesh.cellSize[0] << std::endl;
      std::cout << "mehsLimits1" << vMesh.meshLimits[1] << std::endl;

      std::cout << "mehsLimits1=" << species.velocityMesh << std::endl;
      std::cout << "mehsLimits1=" << species.precipitationNChannels << std::endl;
      std::cout << "mehsLimits1=" << species.sparse_conserve_mass << std::endl;
      std::cout << "mehsLimits1=" << species.sparseBlockAddWidthV << std::endl;
      std::cout << "mehsLimits1=" << species.sparseDynamicAlgorithm << std::endl;

      std::cout << "mehsLimits1=" << species.mass << std::endl;
      std::cout << "mehsLimits1=" << species.mass_units << std::endl;
      std::cout << "mehsLimits1=" << species.EnergyDensityLimit1 << std::endl;
      std::cout << "mehsLimits1=" << species.EnergyDensityLimit2 << std::endl;
      std::cout << "mehsLimits1=" << species.SolarWindSpeed << std::endl;
      std::cout << "mehsLimits1=" << species.SolarWindEnergy << std::endl;
      std::cout << "mehsLimits1=" << species.thermalRadius << std::endl;
      std::cout << "mehsLimits1=" << species.thermalV[0] << std::endl;
   }
